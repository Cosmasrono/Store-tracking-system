  ...
  <div id="signup-form">
    <form @submit.prevent="submitForm" class="form">
      ...
      <div class="form-group">
        ...
        <input v-model.trim="formData.name" type="text" id="name" required />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input v-model.trim="formData.phone" type="tel" id="phone" required />
      </div>
      <div class="form-group">
      ...
      <p>you have account <RouterLink to="/login">login</RouterLink></p>
    </form>
  </div>
</template>
